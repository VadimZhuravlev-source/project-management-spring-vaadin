package com.pmvaadin.project.tasks.repositories;
...
//            )
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<ProjectTaskImpl> findTasksThatFollowToGivenDirection(@Param("ids") Iterable<?> tasksIds, @Param("direction") int direction);
...
//    }
    ...
    @Query(value = """
            ...
            ORDER BY
                ...
                project_tasks.level_order
            """, nativeQuery = true)
    List<ProjectTaskImpl> findTasksThatFollowAfterGivenTasks(@Param("ids") Iterable<?> tasksIds);
